...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(0, 26):
            if i + shift > 25:
                remainder = (i + shift) % 26
                cypher[lower[i]] = lower[remainder]
                cypher[upper[i]] = upper[remainder]
            else:
                cypher[lower[i]] = lower[i + shift]
                cypher[upper[i]] = upper[i + shift]
        return cypher
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            if letter in cypher.keys():
                shifted += cypher[letter]
            else:
                shifted += letter
        return shifted


message = Message("stuff to say")
message.build_shift_dict(3)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        #         if is_word(self.valid_words, word): counter += 1
        #     if counter > best:
        #         best = counter
        #         shift = i
        #         bestList = decrypt
        # return shift, bestList
...
def decrypt_story():
    ...
    decryptStory = encryptStory.decrypt_message()
    return decryptStory
...
plaintext = PlaintextMessage('cat', 1)
...
ciphertext = CiphertextMessage('dbu')
